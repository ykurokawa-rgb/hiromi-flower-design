          ...
          <nav className="hidden items-center gap-6 lg:flex">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className={`relative whitespace-nowrap pb-1 text-sm text-text-main after:absolute after:bottom-0 after:left-0 after:h-[2px] after:rounded-sm after:bg-primary after:transition-all after:duration-300 hover:after:w-full ${
            ...
            <div className="flex items-center gap-2">
              <Link
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full text-text-main transition-all duration-300 hover:-translate-y-0.5 hover:text-primary"
              >
              ...
              <Link
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-[#06C755] text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#05b34d]"
              >
            ...
            <Link
              href="/contact"
              className="whitespace-nowrap rounded-full bg-primary px-5 py-2.5 text-sm font-medium text-white shadow-primary transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary-hover"
            >
              体験に遊びに行く
            </Link>
          </nav>
        ...
        >
          ...
          <div className="mt-2 flex items-center gap-4">
            <Link
              ...
              onClick={closeMenu}
              aria-label="Instagramを見る"
              className="flex h-12 w-12 items-center justify-center rounded-full border border-border text-text-main transition-colors hover:text-primary"
            >
            ...
            <Link
              ...
              aria-label="LINEで友だち追加"
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#06C755] text-white transition-colors hover:bg-[#05b34d]"
            >
